FROM docker.io/node:23.8.0-slim@sha256:054f13a53d12afb8ba84a6e8fdcdf54e1a99a93250426c83fd5e3d38343577c2 AS frontend-builder
WORKDIR /app
...
FROM docker.io/golang:1.24.0@sha256:2b1cbf278ce05a2a310a3d695ebb176420117a8cfcfcc4e5e68a1bef5f6354da AS backend-builder
WORKDIR /app
